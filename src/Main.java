...
public class Main {
	...
	private static void CreateSpatialAreas() throws WrongSubAreaException
	{
		...
		SpatialArea israel = new SpatialArea(1,"israel",150,300,5,isrPol);//has no father
		SpatialArea north = new SpatialArea(2,"north",150,300,5,nrthPol,israel);
		SpatialArea middle = new SpatialArea(3,"middle",150,300,5,midPol,israel);
		SpatialArea south = new SpatialArea(4,"south",150,300,5,sothPol,israel);
...
//		
		...
		SpatialAreasUtil.deepSortForSpatialArea(israel, new SpatialArea.BySouthToNorth());
		System.out.println(israel);
